...
#include "carla/sensor/s11n/CalyoPulseSerializer.h" // Custom Calyo Sensor
...
class ACalyoPulse; // Custom Calyo Sensor
...
namespace sensor {
  ...
  using SensorRegistry = CompositeSerializer<
    ...
    std::pair<ACalyoPulse *, s11n::CalyoPulseSerializer> // Custom Calyo Sensor
...
#include "Carla/Sensor/CalyoPulse.h" //Custom Calyo Sensor
