//~/carla/Unreal/CarlaUE4/Plugins/Carla/Source/Carla/Actor/ActorBlueprintFunctionLibrary.h
...
public:
  ...
  //' CUSTOM SENSOR '
  static FActorDefinition MakeCalyoPulseDefinition();

  UFUNCTION(Category = "Carla Actor", BlueprintCallable)
  static void MakeCalyoPulseDefinition(
      bool &Success,
      FActorDefinition &Definition);
//
  ...
  static void SetCalyoPulse(const FActorDescription &Description, ACalyoPulse *Calyo);
